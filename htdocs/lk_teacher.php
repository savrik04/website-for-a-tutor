	...
	<div class="container mt-4">
		...
		<?php
			...
			if ($result->num_rows > 0) {
				...
				echo "<b>Фамилия Имя Отчество:</b> " . $user["name"] . "<br>". "<b>Telegram:</b> " . $user["tg"] . "<br>". "<b>Email:</b> " . $user["email"] . "<br>". "<b>Номер телефона:</b> " . $user["tel"] . "<br>". "<b>Дата рождения:</b> " . $user["birth"] . "<br>". "<b>Предоставляемые услуги:</b> " . $user["service"] . "<br>". "<b>Цены за услуги:</b> " . $user["price"] . "<br>";
