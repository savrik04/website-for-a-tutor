	      ...
	      <div class="col-lg-8 col-xl-6">
	        <div class="card rounded-3">
	          <div class="card-body p-4 p-md-5">
	            ...
	            <form class="px-md-2" action="php/reg.php" method="post">
	              ...
	              <div class="mb-4">
	                ...
	                <select data-mdb-select-init id="types" name="types" class="w-25 form-select-sm me-2">
	                  <option value="3" disabled>Должность</option>
	            ...
	            <a href="login_page.php" class="text-center">Есть аккаунт</a>
	          </div>
	        </div>
	      </div>
	    </div>
